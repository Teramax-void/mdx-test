    ...
    switch (activeSection) {
      case 'introduction':
        return (
          <div className="space-y-8">
            ...
            <div className="bg-black/50 border border-gray-800 rounded-xl p-8 relative overflow-hidden">
            ...
            <div className="bg-black/50 border border-gray-800 rounded-xl p-8 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4 p-4 bg-gray-900/30 rounded-lg border border-gray-700/30 hover:border-cyan-500/30 transition-all duration-300">
                    ...
                    <span className="text-gray-300">Understand object-oriented programming concepts</span>
                  </div>
                  <div className="flex items-start space-x-4 p-4 bg-gray-900/30 rounded-lg border border-gray-700/30 hover:border-purple-500/30 transition-all duration-300">
                    ...
                    <span className="text-gray-300">Master Java language syntax and semantics</span>
                  </div>
                  <div className="flex items-start space-x-4 p-4 bg-gray-900/30 rounded-lg border border-gray-700/30 hover:border-green-500/30 transition-all duration-300">
                    ...
                    <span className="text-gray-300">Design and implement object-oriented solutions</span>
                  </div>
                  <div className="flex items-start space-x-4 p-4 bg-gray-900/30 rounded-lg border border-gray-700/30 hover:border-yellow-500/30 transition-all duration-300">
                    ...
                    <span className="text-gray-300">Apply inheritance and polymorphism principles</span>
                  </div>
                  <div className="flex items-start space-x-4 p-4 bg-gray-900/30 rounded-lg border border-gray-700/30 hover:border-blue-500/30 transition-all duration-300">
                    ...
                    <span className="text-gray-300">Develop debugging and testing skills</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      case 'encapsulation':
        return (
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl font-bold text-white mb-6">Encapsulation</h1>
              <p className="text-xl text-gray-400 leading-relaxed">
            ...
            <div className="bg-black/50 border border-gray-800 rounded-xl p-8">
              <h2 className="text-2xl font-bold text-white mb-4">What is Encapsulation?</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
      ...
      <div className="flex-1 flex min-w-0 ml-80">
        ...
        <div className="w-64 border-l border-gray-800 flex-shrink-0">
          <div className="sticky top-0 h-screen overflow-y-auto p-8">
            <h3 className="text-sm font-bold text-gray-400 mb-4 tracking-widest">ON THIS PAGE</h3>
            <div className="space-y-2">
              <a href="#course-overview" className="block text-sm text-gray-400 hover:text-cyan-400 transition-colors duration-300">
                Course Overview
              </a>
              <a href="#learning-outcomes" className="block text-sm text-gray-400 hover:text-cyan-400 transition-colors duration-300">
                Learning Outcomes
              </a>
              <a href="#getting-started" className="block text-sm text-gray-400 hover:text-cyan-400 transition-colors duration-300">
                Getting Started
              </a>
            </div>
          </div>
